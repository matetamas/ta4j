...
public class StocksTimeSeriesManagerTest {
    private TimeSeries seriesForRun;

    private StocksTimeSeriesManager manager;
    ...
    public void setUp() {
        ...
        manager = new StocksTimeSeriesManager(seriesForRun, cash, vm);
    ...
    public void runOnWholeSeriesWithAmount() {
        ...
        assertEquals(2, allTrades.size());
        assertEquals(Decimal.TEN, allTrades.get(0).getEntry().getAmount());
        assertEquals(Decimal.TEN, allTrades.get(1).getEntry().getAmount());
    ...
    public void runOnSeries() {
        ...
        assertEquals(Order.buyAt(2, seriesForRun.getBar(2).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.sellAt(4, seriesForRun.getBar(4).getClosePrice(), Decimal.TEN), trades.get(0).getExit());

        assertEquals(Order.buyAt(6, seriesForRun.getBar(6).getClosePrice(), Decimal.TEN), trades.get(1).getEntry());
        assertEquals(Order.sellAt(7, seriesForRun.getBar(7).getClosePrice(), Decimal.TEN), trades.get(1).getExit());
    }
    ...
    public void runWithOpenEntryBuyLeft() {
        ...
        assertEquals(Order.buyAt(1, seriesForRun.getBar(1).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.sellAt(3, seriesForRun.getBar(3).getClosePrice(), Decimal.TEN), trades.get(0).getExit());
    }
    ...
    public void runWithOpenEntrySellLeft() {
        ...
        assertEquals(Order.sellAt(1, seriesForRun.getBar(1).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.buyAt(3, seriesForRun.getBar(3).getClosePrice(), Decimal.TEN), trades.get(0).getExit());
    }
    ...
    public void runBetweenIndexes() {
        ...
        assertEquals(1, trades.size());
        assertEquals(Order.buyAt(6, seriesForRun.getBar(6).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.sellAt(7, seriesForRun.getBar(7).getClosePrice(), Decimal.TEN), trades.get(0).getExit());
    }
    ...
    public void runOnSeriesSlices(){
        ...
        assertEquals(1, trades.size());
        assertEquals(Order.buyAt(0, series.getBar(0).getClosePrice(), Decimal.TEN),trades.get(0).getEntry());
        assertEquals(Order.sellAt(2, series.getBar(2).getClosePrice(), Decimal.TEN), trades.get(0).getExit());

        trades = manager.run(aStrategy, 2, 3).getTrades();
        assertEquals(1, trades.size());
        assertEquals(Order.buyAt(3, series.getBar(3).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.sellAt(4, series.getBar(4).getClosePrice(), Decimal.TEN), trades.get(0).getExit());

        trades = manager.run(aStrategy, 4, 6).getTrades();
        assertEquals(1, trades.size());
        assertEquals(Order.buyAt(5, series.getBar(5).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.sellAt(6, series.getBar(6).getClosePrice(), Decimal.TEN), trades.get(0).getExit());

        trades = manager.run(aStrategy, 7, 7).getTrades();
        assertEquals(1, trades.size());
        assertEquals(Order.buyAt(7, series.getBar(7).getClosePrice(), Decimal.TEN), trades.get(0).getEntry());
        assertEquals(Order.sellAt(9, series.getBar(9).getClosePrice(), Decimal.TEN), trades.get(0).getExit());
